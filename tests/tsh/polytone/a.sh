...
# val2
sed -i.bak "/^\[api\]/,/^\[/ s/minimum-gas-prices.*/minimum-gas-prices = \"0.0uterp\"/" $VAL2HOME/config/app.toml &&
...
# init note
 $BIND tx wasm i $POLYONE_NOTE_ID '{"block_max_gas": "100000000" }' --from $DEL --home $VAL1HOME --chain-id $CHAINID_A --no-admin --label="note contract chain1" --fees 400000uterp --gas auto --gas-adjustment 1.3 -y 
 $BIND tx wasm i $POLYONE_NOTE_ID '{"block_max_gas": "100000000" }' --from $USER --home $VAL2HOME --chain-id $CHAINID_B --no-admin --label="note contract chain2" --fees 400000uterp --gas auto --gas-adjustment 1.3 -y
sleep 3
# init voice
 $BIND tx wasm i $POLYONE_VOICE_ID '{"proxy_code_id":"3","block_max_gas":"100000000" }' --from $DEL --home $VAL1HOME --chain-id $CHAINID_A --no-admin --label="voice contract chain1" -y --fees 400000uterp --gas auto --gas-adjustment 1.3
 $BIND tx wasm i $POLYONE_VOICE_ID '{"proxy_code_id":"3","block_max_gas":"100000000" }' --from $DEL --home $VAL2HOME --chain-id $CHAINID_B --no-admin --label="voice contract chain1" -y --fees 400000uterp --gas auto --gas-adjustment 1.3
sleep 5
# init tester
 $BIND tx wasm i $POLYONE_TESTER_ID '{}' --from $DEL --home $VAL1HOME --no-admin --label="tester contract chain1" --fees 400000uterp --gas auto --gas-adjustment 1.3 -y 
 $BIND tx wasm i $POLYONE_TESTER_ID '{}' --from $DEL --home $VAL2HOME --no-admin --label="tester contract chain2" --fees 400000uterp --gas auto --gas-adjustment 1.3 -y 
sleep 3
...
# init listener
 $BIND tx wasm i $POLYONE_LISTENER_ID "{\"note\":\"$POLYONE_NOTE_ADDR_A\"}" --from $DEL --home $VAL1HOME --no-admin --label="listener contract chain1" --fees 400000uterp --gas auto --gas-adjustment 1.3 -y 
 $BIND tx wasm i $POLYONE_LISTENER_ID "{\"note\":\"$POLYONE_NOTE_ADDR_B\"}" --from $DEL --home $VAL2HOME --no-admin --label="listener contract chain2" --fees 400000uterp --gas auto --gas-adjustment 1.3 -y 
...
# send msg to note
$BIND tx wasm e $POLYONE_NOTE_ADDR_A "{\"execute\":{\"msgs\":[],\"timeout_seconds\":\"100\",\"callback\": {\"receiver\": \"$POLYONE_TESTER_ADDR_A\", \"msg\":\"aGVsbG8K\"}}}" --home $VAL1HOME --from $DEL -y --fees 400000uterp --gas auto --gas-adjustment 1.3
sleep 3


$BIND tx wasm e $POLYONE_NOTE_ADDR_B "{\"execute\":{\"msgs\":[],\"timeout_seconds\":\"100\",\"callback\": {\"receiver\": \"$POLYONE_TESTER_ADDR_B\", \"msg\":\"aGVsbG8K\"}}}" --home $VAL2HOME --from $DEL -y --fees 400000uterp --gas auto --gas-adjustment 1.3
...
$BIND q wasm contract-state smart $POLYONE_TESTER_ADDR_A '{"history":{}}' -o json  --home $VAL1HOME
$BIND q wasm contract-state smart $POLYONE_TESTER_ADDR_B '{"history":{}}' -o json  --home $VAL2HOME
