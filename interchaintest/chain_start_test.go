// terp source: https://github.com/strangelove-ventures/interchaintest/blob/main/examples/cosmos/chain_core_test.go#L161
...
func TestBasicBtsgStart(t *testing.T) {
	...
	users := interchaintest.GetAndFundTestUsers(t, ctx, t.Name(), userFunds, terp)
	println("users", users)
	// chainUser := users[0]
...
func testDistribution(ctx context.Context, t *testing.T, chain *cosmos.CosmosChain, users []ibc.Wallet) {
	...
	newWithdrawAddr := "terp138wd4e3sjpnz28r8t3cjqnq0wvhd02nfq9jdtf"
