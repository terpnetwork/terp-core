...
func SimulateMsgUpdateTerpid(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		if !found {
			return simtypes.NoOpMsg(types.ModuleName, msg.Type(), "terpid creator not found"), nil, nil
		}
