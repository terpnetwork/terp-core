...
func init() {
	proto.RegisterType((*Supplychain)(nil), "terpnetwork.terp.terp.Supplychain")
}

func init() { proto.RegisterFile("terp/supplychain.proto", fileDescriptor_b6988f475c438d71) }
