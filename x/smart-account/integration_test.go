...
import (
	...
	terpibctesting "github.com/terpnetwork/terp-core/v6/tests/ibctesting"
...
func (s *AuthenticatorSuite) TestAuthenticatorGas() {
	...
	alwaysLow := moduletestutils.TestingAuthenticator{Approve: moduletestutils.Always, GasConsumption: 0}
	// Will always approve and will consume 4k gas
	alwaysHigh := moduletestutils.TestingAuthenticator{Approve: moduletestutils.Always, GasConsumption: 4_000}
	// Will always approve and will consume 500k gas
	alwaysHigher := moduletestutils.TestingAuthenticator{Approve: moduletestutils.Always, GasConsumption: 500_000}
...
func (s *AuthenticatorSuite) TestAuthenticatorAddRemove() {
	...
	blockAdd := moduletestutils.TestingAuthenticator{BlockAddition: true}
	allowAdd := moduletestutils.TestingAuthenticator{}
	blockRemove := moduletestutils.TestingAuthenticator{BlockRemoval: true}
	allowRemove := moduletestutils.TestingAuthenticator{}
...
func (s *AuthenticatorSuite) TestFeeDeduction() {
	...
	alwaysAuth := moduletestutils.TestingAuthenticator{Approve: moduletestutils.Always}
	neverAuth := moduletestutils.TestingAuthenticator{Approve: moduletestutils.Never}
