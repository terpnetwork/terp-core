...
func (s *AuthenticatorCircuitBreakerAnteSuite) TestCircuitBreakerAnte() {
	...
	params := s.TerpApp.SmartAccountKeeper.GetParams(s.Ctx)
	params.IsSmartAccountActive = false
	s.TerpApp.SmartAccountKeeper.SetParams(s.Ctx, params)
	...
	params = s.TerpApp.SmartAccountKeeper.GetParams(ctx)
	params.IsSmartAccountActive = true
	s.TerpApp.SmartAccountKeeper.SetParams(ctx, params)
