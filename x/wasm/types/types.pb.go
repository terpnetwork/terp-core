...
type AccessTypeParam struct {
	Value AccessType `protobuf:"varint,1,opt,name=value,proto3,enum=terpnetwork.wasm.v1.AccessType" json:"value,omitempty" yaml:"value"`
}
...
type AccessConfig struct {
	Permission AccessType `protobuf:"varint,1,opt,name=permission,proto3,enum=terpnetwork.wasm.v1.AccessType" json:"permission,omitempty" yaml:"permission"`
...
type Params struct {
	...
	InstantiateDefaultPermission AccessType   `protobuf:"varint,2,opt,name=instantiate_default_permission,json=instantiateDefaultPermission,proto3,enum=terpnetwork.wasm.v1.AccessType" json:"instantiate_default_permission,omitempty" yaml:"instantiate_default_permission"`
}
...
type ContractCodeHistoryEntry struct {
	Operation ContractCodeHistoryOperationType `protobuf:"varint,1,opt,name=operation,proto3,enum=terpnetwork.wasm.v1.ContractCodeHistoryOperationType" json:"operation,omitempty"`
	// CodeID is the reference to the stored WASM code
...
func init() {
	proto.RegisterEnum("terpnetwork.wasm.v1.AccessType", AccessType_name, AccessType_value)
	proto.RegisterEnum("terpnetwork.wasm.v1.ContractCodeHistoryOperationType", ContractCodeHistoryOperationType_name, ContractCodeHistoryOperationType_value)
	proto.RegisterType((*AccessTypeParam)(nil), "terpnetwork.wasm.v1.AccessTypeParam")
	proto.RegisterType((*AccessConfig)(nil), "terpnetwork.wasm.v1.AccessConfig")
	proto.RegisterType((*Params)(nil), "terpnetwork.wasm.v1.Params")
	proto.RegisterType((*CodeInfo)(nil), "terpnetwork.wasm.v1.CodeInfo")
	proto.RegisterType((*ContractInfo)(nil), "terpnetwork.wasm.v1.ContractInfo")
	proto.RegisterType((*ContractCodeHistoryEntry)(nil), "terpnetwork.wasm.v1.ContractCodeHistoryEntry")
	proto.RegisterType((*AbsoluteTxPosition)(nil), "terpnetwork.wasm.v1.AbsoluteTxPosition")
	proto.RegisterType((*Model)(nil), "terpnetwork.wasm.v1.Model")
}

func init() { proto.RegisterFile("wasm/types.proto", fileDescriptor_a7266c8e681b8229) }
