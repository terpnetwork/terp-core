...
func TestStoreCodeProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			src := types.StoreCodeProposalFixture(func(p *types.StoreCodeProposal) { //nolint:staticcheck // testing a deprecated library
...
func TestInstantiateProposal(t *testing.T) {
	...
	src := types.InstantiateContractProposalFixture(func(p *types.InstantiateContractProposal) { //nolint:staticcheck // testing a deprecated library
...
func TestInstantiate2Proposal(t *testing.T) {
	...
	src := types.InstantiateContract2ProposalFixture(func(p *types.InstantiateContract2Proposal) { //nolint:staticcheck // testing a deprecated library
		p.CodeID = firstCodeID
		p.RunAs = oneAddress.String()
		p.Admin = otherAddress.String()
		p.Label = label
...
func TestStoreAndInstantiateContractProposal(t *testing.T) {
	...
	src := types.StoreAndInstantiateContractProposalFixture(func(p *types.StoreAndInstantiateContractProposal) { //nolint:staticcheck // testing a deprecated library
...
func TestMigrateProposal(t *testing.T) {
	...
	src := &types.MigrateContractProposal{ //nolint:staticcheck // testing a deprecated library
		Title:       "Foo",
		Description: "Bar",
		CodeID:      2,
...
func TestExecuteProposal(t *testing.T) {
	...
	badSrc := &types.ExecuteContractProposal{ //nolint:staticcheck // testing a deprecated library
		Title:       "First",
	...
	src := &types.ExecuteContractProposal{ //nolint:staticcheck // testing a deprecated library
		Title:       "Second",
...
func TestSudoProposal(t *testing.T) {
	...
	src := &types.SudoContractProposal{ //nolint:staticcheck // testing a deprecated library
		Title:       "Sudo",
...
func TestAdminProposals(t *testing.T) {
	...
	specs := map[string]struct {
		...
		"update with different admin": {
			...
			srcProposal: &types.UpdateAdminProposal{ //nolint:staticcheck // testing a deprecated library
				Title:       "Foo",
				Description: "Bar",
				Contract:    contractAddr.String(),
		...
		"clear admin": {
			state: types.ContractInfoFixture(),
			srcProposal: &types.ClearAdminProposal{ //nolint:staticcheck // testing a deprecated library
				Title:       "Foo",
				Description: "Bar",
				Contract:    contractAddr.String(),
			},
...
func TestPinCodesProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			proposal := &types.PinCodesProposal{ //nolint:staticcheck // testing a deprecated library
				Title:       "Foo",
				Description: "Bar",
...
func TestUnpinCodesProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			proposal := &types.UnpinCodesProposal{ //nolint:staticcheck // testing a deprecated library
				Title:       "Foo",
				Description: "Bar",
				CodeIDs:     spec.srcCodeIDs,
			}
...
func TestUpdateInstantiateConfigProposal(t *testing.T) {
	...
	for msg, spec := range specs {
		t.Run(msg, func(t *testing.T) {
			...
			govAuthority := keepers.AccountKeeper.GetModuleAddress(govtypes.ModuleName).String()
			msgServer := govkeeper.NewMsgServerImpl(keepers.GovKeeper)
			proposal := &types.UpdateInstantiateConfigProposal{ //nolint:staticcheck // testing a deprecated library
				Title:               "Foo",
				Description:         "Bar",
