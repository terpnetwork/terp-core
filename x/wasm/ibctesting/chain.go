...
// DefaultTerpAppFactory instantiates and sets up the default wasmd app
func DefaultTerpAppFactory(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, opts []wasm.Option, balances ...banktypes.Balance) ChainApp {
...
func NewDefaultTestChain(t *testing.T, coord *Coordinator, chainID string, opts ...wasm.Option) *TestChain {
	return NewTestChain(t, coord, DefaultTerpAppFactory, chainID, opts...)
}
