...
![acceptance-tests.png](https://github.com/cosmos/cosmos-sdk/blob/main/docs/static/img/acceptance-tests.png)
...
We are forming a QA team that will support the core terp-core team and collaborators by:

* Improving the Terp-Core QA Processes
...
* QA is happening in parallel with Core Terp-Core development.
