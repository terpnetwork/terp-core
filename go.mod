module github.com/terpnetwork/terp-core/v5
...
replace (
	cosmossdk.io/store => github.com/permissionlessweb/cosmos-sdk/store v1.1.2-0.20260120182310-f2d25dd421dc
	// custom x/wasm module for circuit vk
	github.com/CosmWasm/wasmd => github.com/permissionlessweb/wasmd v0.0.0-20260120184943-43a7065a7627
	// custom zk-wasmvm for pinned circuit verification keys
	github.com/CosmWasm/wasmvm/v3 => github.com/permissionlessweb/wasmvm/v3 v3.0.0-20260114010413-e9138f005d2d
