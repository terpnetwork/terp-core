...
const (
	Query_Params_FullMethodName            = "/terp.smartaccount.v1beta1.Query/Params"
	Query_GetAuthenticator_FullMethodName  = "/terp.smartaccount.v1beta1.Query/GetAuthenticator"
	Query_GetAuthenticators_FullMethodName = "/terp.smartaccount.v1beta1.Query/GetAuthenticators"
)
...
func (UnimplementedQueryServer) GetAuthenticator(context.Context, *GetAuthenticatorRequest) (*GetAuthenticatorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAuthenticator not implemented")
}
func (UnimplementedQueryServer) GetAuthenticators(context.Context, *GetAuthenticatorsRequest) (*GetAuthenticatorsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAuthenticators not implemented")
}
