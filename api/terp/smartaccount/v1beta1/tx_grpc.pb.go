...
const (
	Msg_AddAuthenticator_FullMethodName    = "/terp.smartaccount.v1beta1.Msg/AddAuthenticator"
	Msg_RemoveAuthenticator_FullMethodName = "/terp.smartaccount.v1beta1.Msg/RemoveAuthenticator"
	Msg_SetActiveState_FullMethodName      = "/terp.smartaccount.v1beta1.Msg/SetActiveState"
)
...
func (UnimplementedMsgServer) AddAuthenticator(context.Context, *MsgAddAuthenticator) (*MsgAddAuthenticatorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddAuthenticator not implemented")
}
func (UnimplementedMsgServer) RemoveAuthenticator(context.Context, *MsgRemoveAuthenticator) (*MsgRemoveAuthenticatorResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveAuthenticator not implemented")
}
func (UnimplementedMsgServer) SetActiveState(context.Context, *MsgSetActiveState) (*MsgSetActiveStateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetActiveState not implemented")
}
