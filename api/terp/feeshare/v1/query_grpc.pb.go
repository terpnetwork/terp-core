...
const (
	Query_FeeShares_FullMethodName           = "/terp.feeshare.v1.Query/FeeShares"
	Query_FeeShare_FullMethodName            = "/terp.feeshare.v1.Query/FeeShare"
	Query_Params_FullMethodName              = "/terp.feeshare.v1.Query/Params"
	Query_DeployerFeeShares_FullMethodName   = "/terp.feeshare.v1.Query/DeployerFeeShares"
	Query_WithdrawerFeeShares_FullMethodName = "/terp.feeshare.v1.Query/WithdrawerFeeShares"
)
...
func (UnimplementedQueryServer) FeeShares(context.Context, *QueryFeeSharesRequest) (*QueryFeeSharesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FeeShares not implemented")
}
func (UnimplementedQueryServer) FeeShare(context.Context, *QueryFeeShareRequest) (*QueryFeeShareResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FeeShare not implemented")
}
...
func (UnimplementedQueryServer) DeployerFeeShares(context.Context, *QueryDeployerFeeSharesRequest) (*QueryDeployerFeeSharesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeployerFeeShares not implemented")
}
func (UnimplementedQueryServer) WithdrawerFeeShares(context.Context, *QueryWithdrawerFeeSharesRequest) (*QueryWithdrawerFeeSharesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WithdrawerFeeShares not implemented")
}
