...
const (
	Query_ClockContracts_FullMethodName = "/terp.clock.v1.Query/ClockContracts"
	Query_Params_FullMethodName         = "/terp.clock.v1.Query/Params"
)
...
func (UnimplementedQueryServer) ClockContracts(context.Context, *QueryClockContracts) (*QueryClockContractsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ClockContracts not implemented")
}
