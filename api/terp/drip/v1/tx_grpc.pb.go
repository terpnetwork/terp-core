...
const (
	Msg_DistributeTokens_FullMethodName = "/terp.drip.v1.Msg/DistributeTokens"
	Msg_UpdateParams_FullMethodName     = "/terp.drip.v1.Msg/UpdateParams"
)
...
func (UnimplementedMsgServer) DistributeTokens(context.Context, *MsgDistributeTokens) (*MsgDistributeTokensResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DistributeTokens not implemented")
}
