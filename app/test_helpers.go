...
func Setup(t *testing.T, isCheckTx bool, opts ...wasm.Option) *TerpApp {
	privVal := mock.NewPV()
...
func SetupTerpAppWithValSet(t *testing.T) *TerpApp {
...
func AddTestAddrsFromPubKeys(app *TerpApp, ctx sdk.Context, pubKeys []cryptotypes.PubKey, accAmt math.Int) {
...
func AddTestAddrs(app *TerpApp, ctx sdk.Context, accNum int, accAmt math.Int) []sdk.AccAddress {
...
func addTestAddrs(app *TerpApp, ctx sdk.Context, accNum int, accAmt math.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
