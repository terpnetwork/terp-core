...
func runConfigCmd(cmd *cobra.Command, args []string) error {
	...
	tcc := TerpCustomClient{
		*conf,
		os.Getenv("TERPD_GAS"),
		os.Getenv("TERPD_GAS_PRICES"),
		os.Getenv("TERPD_GAS_ADJUSTMENT"),

		os.Getenv("TERPD_FEES"),
		os.Getenv("TERPD_FEE_GRANTER"),
		os.Getenv("TERPD_FEE_PAYER"),

		os.Getenv("TERPD_NOTE"),
	}
...
// configFilePath.
func writeConfigToFile(configFilePath string, config *TerpCustomClient) error {
