...
// getSHA256TestTree builds a tree with legacy SHA-256 hashing for ICS23 IavlSpec tests.
func getSHA256TestTree(cacheSize int) *MutableTree {
	return NewMutableTree(dbm.NewMemDB(), cacheSize, false, NewNopLogger(), SHA256Option())
}
